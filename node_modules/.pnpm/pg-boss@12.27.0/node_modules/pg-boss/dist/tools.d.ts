 ...
 */
declare function resolveSchemaName(schema: string): string;
/**
 ...
 */
declare function normalizeSchemaName(schema: string): string;
export { delay, normalizeSchemaName, resolveSchemaName, resolveWithinSeconds, unwrapSQLResult };
